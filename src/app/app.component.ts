...
import {
  ...
  layersOutline, cloudUploadOutline, barcodeOutline
} from 'ionicons/icons';
...
export class AppComponent implements OnInit {
  ...
  constructor(
    ...
    addIcons({
      ...
      buildOutline, addCircleOutline, createOutline, albumsOutline, layersOutline, cloudUploadOutline, barcodeOutline
    });
